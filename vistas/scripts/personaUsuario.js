...
function listar(){
	...
	tabla=$('#tbllistado').dataTable({
		...
		"ajax":
				{
					url: '../ajax/personaUsuario.php?op=listar',
					type : "get",
					dataType : "json",						
					error: function(e){
...
function guardaryeditar(e){
	...
	$.ajax({
		...
		url: "../ajax/personaUsuario.php?op=guardaryeditar",
		type: "POST",
		data: formData,
		contentType: false,
		processData: false,
...
function mostrar(idpersona){
	...
	$.post("../ajax/personaUsuario.php?op=mostrar",{idpersona : idpersona}, function(data, status){
...
function desactivar(idpersona){
	...
	bootbox.confirm("¿Está seguro de desactivar a esta persona?", function(result){
		...
		if(result){
			...
			$.post("../ajax/personaUsuario.php?op=desactivar", {idpersona : idpersona}, function(e){
...
function activar(idpersona){
	...
	bootbox.confirm("¿Está seguro de activar a esta persona?", function(result){
		...
		if(result){
			...
			$.post("../ajax/personaUsuario.php?op=activar", {idpersona : idpersona}, function(e){
